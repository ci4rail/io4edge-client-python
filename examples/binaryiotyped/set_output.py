...
def main():
    parser = argparse.ArgumentParser(
        description="set output with binary i/o type D client"
    )
    parser.add_argument(
        "addr", help="MDNS address or IP:Port of the function block", type=str
    )
    parser.add_argument("channel", help="Channel number to set", type=int)
    parser.add_argument("state", help="State to set (0=inactive, 1=active)", type=int)
